...
\hypersetup{
  pdftitle={Titre du projet de recherche},
  pdfauthor={auteur},
  hidelinks,
...
\title{Titre du projet de recherche}
\author{auteur}
\date{2020-12-11}
...
Cette section comprend les résulats de votre recherche. Il s'agit donc d'une sythèse des éléments les plus importants de vos notebook.

\hypertarget{premiuxe8re-section-de-mes-ruxe9sultats}{%
\section{Première section de mes résultats}\label{premiuxe8re-section-de-mes-ruxe9sultats}}

\hypertarget{seconde-section-de-mes-ruxe9sultats}{%
\section{Seconde section de mes résultats}\label{seconde-section-de-mes-ruxe9sultats}}
